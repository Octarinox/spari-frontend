...
export default function FacerecPage() {
    ...
    const DeleteFetch = useCallback(async (image_id: any) => {
        await deleteSubjectImage(image_id);
        window.location.reload();
    }, []);
        ...
        <>
            {role === 'admin' || perms?.includes(PERMISSIONS.FACE_DATABASE) ? (
                <div>
                    ...
                    >
                        <Box
                            className="justify-center flex absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[600px] bg-white rounded-lg shadow-lg">
                    ...
                    <div className="flex justify-center p-10 h-[60rem]">
                        <aside
                            className="border-[1px] scrollbar-thin text-center p-2 scrollbar-thumb-gray-100 scrollbar-track-gray-200 overflow-y-scroll border-gray-200 bg-gray-200 w-[20rem] rounded-l-3xl h-full">
                            <div className="h-[95%]">
                        ...
                        <main className="border-[1px] bg-gray-50 w-[50rem] rounded-r-3xl h-full">
                            {CurrentSub != 'NTS' ? (
                                <header
                                    className="w-full flex text-center rounded-b-3xl shadow-lg bg-gray-200 border-gray-200 text-gray-600 justify-center font-black text-2xl border-b-[2px]">
